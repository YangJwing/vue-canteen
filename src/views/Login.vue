 ...
 * @修改人: Edwin Yeung
 * @LastEditTime: 2020-03-17 22:54:22
 * @描述: 
 -->
  ...
  <div class="login">
    ...
    <van-form @submit="onSubmit">
      ...
      <div style="margin:16px">
        <van-button round block type="info" natve-type="submi">提交</van-button>
      </div>
     ...
     onSubmit(values) {
      ...
      this.$http
        ...
        .then(response => {
          ...
          //记录登录日志
          this.$http.post("/api/user/loginlog", loginData).then(response => {});
        })
        .catch(err => {
          console.log("错误:", err);
